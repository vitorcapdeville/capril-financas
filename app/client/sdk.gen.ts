...
export const countClientes = <ThrowOnError extends boolean = false>(options?: Options<CountClientesData, ThrowOnError>) => {
    return (options?.client ?? client).get<CountClientesResponse, CountClientesError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const countCompras = <ThrowOnError extends boolean = false>(options?: Options<CountComprasData, ThrowOnError>) => {
    return (options?.client ?? client).get<CountComprasResponse, CountComprasError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const countFornecedores = <ThrowOnError extends boolean = false>(options?: Options<CountFornecedoresData, ThrowOnError>) => {
    return (options?.client ?? client).get<CountFornecedoresResponse, CountFornecedoresError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const countProdutos = <ThrowOnError extends boolean = false>(options?: Options<CountProdutosData, ThrowOnError>) => {
    return (options?.client ?? client).get<CountProdutosResponse, CountProdutosError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const countVendas = <ThrowOnError extends boolean = false>(options?: Options<CountVendasData, ThrowOnError>) => {
    return (options?.client ?? client).get<CountVendasResponse, CountVendasError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
